...
export default function App({ appTitle, useCustom, customArgs }: AppProps) {
  ...
  const customFileOpen: FileOpen = async <
  ...
  >(opts: {
    ...
    console.log("custom open file", opts.extensions, opts.multiple);
    if (opts.multiple) {
      // When `multiple` is true, return an array of Files
      return [] as any as M extends false | undefined ? File : File[];
    }
    // When `multiple` is false or undefined, return a single File
    return {} as any as M extends false | undefined ? File : File[];
  };
    ...
    <div className="App" ref={appRef}>
      ...
      <ExampleSidebar>
        <div className="button-wrapper">
          ...
          <div>
            <label htmlFor="colorPickerStr">Targets stroke color: </label>
            <input
              id="colorPickerStr"
              type="color"
              value={"#ff0000"}
              onChange={(event) => {
                excalidrawAPI?.invokeAction("changeStrokeColor", {
                  currentItemStrokeColor: event.target.value,
                });
              }}
            />
          </div>
          ...
          <div>
            <label htmlFor="colorPickerBg">Targets background color: </label>
            <input
              id="colorPickerBg"
              type="color"
              value={"#ff0000"}
              onChange={(event) => {
                excalidrawAPI?.invokeAction("changeBackgroundColor", {
                  currentItemBackgroundColor: event.target.value,
                });
              }}
            />
          </div>
        ...
        <div className="excalidraw-wrapper">
          <Excalidraw
            ...
            onChange={(elements, state) => {
              ...
              console.log("Select target element", targetElements);
            }}
            ...
            theme={theme}
            name="Nguyen Ba Cu name of drawing"
            UIOptions={{
              canvasActions: {
                loadScene: false,
                export: false,
