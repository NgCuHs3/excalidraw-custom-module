...
class App extends React.Component<AppProps, AppState> {
  ...
  private onImageAction = async ({
    ...
    try {
      ...
      // priority custom open file
      const currentfileOpen = this.props.customFileOpen || fileOpen;

      const imageFile = await currentfileOpen({
        description: "Image",
  ...
  private handleCanvasContextMenu = (
    ...
    event.preventDefault();
    // don't hand;e canvas context menu
    return;
    // if (
  ...
  public invokeAction(
    ...
    value: Parameters<Action["perform"]>[2] = null,
  ) {
    const action = this.actionManager.actions[actionName];
